...
# Function to submit detected characters to the Ollama API
        ...
        if not cap.isOpened():
            ...
            while run:
                ...
                if predicted_character and (current_time - st.session_state.last_detection_time) > 2:
                    ...
                    # If the detected character is "B", automatically submit the detected characters
                    if predicted_character == "B":
                        st.write("Detected 'B' gesture. Submitting detected characters...")
                        submit_to_ollama()
